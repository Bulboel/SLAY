...
Prototype web original d’un mini-RPG de capture de créatures à Hackénia.

## Version actuelle

- Écran titre et choix du nom du personnage
- Maison du joueur et Sexyflex
- Bitch City agrandie avec quatre maisons espacées, deux encore libres
...
- Création du personnage au lancement : silhouette, tenue et coiffure
- Nouvel écran-titre fantasy sur la carte d’Hackénia
...
Ouvrir `dist/index.html` dans un navigateur moderne.

## Direction artistique

Les graphismes actuels servent uniquement de maquette fonctionnelle. Tous les
personnages, Slays et décors définitifs utiliseront des créations originales.
